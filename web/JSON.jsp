...
<t:baseTemplate pageName="Home">
    ...
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
        ...
        <div id="jsonsection">
            ...
            {"firstName" : "Kurt", "lastName" : "Olsen", "email" : "my@email.dk",
            ...
            <p>
                ...
                forstå og arbejde med. Ved at benytte gson library til at lave et Person object med 
                kan vi tildele det, de properties som Json objectet havde
